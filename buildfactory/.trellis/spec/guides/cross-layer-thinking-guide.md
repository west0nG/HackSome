...
- [ ] If the change touches transcripts, cost fields, subagent mechanisms, or
      skills paths: handled BOTH agent runtimes (claude-code + codex) or wrote
      an explicit degraded mode — see backend/agent-execution-contracts.md
      Scenario E (dual-runtime consumer surfaces)
