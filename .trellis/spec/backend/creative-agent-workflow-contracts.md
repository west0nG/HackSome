...
- C3 v4 在既有 sections 内要求 `User does:`、
  ...
  的外部 evidence，也不改变 C3 只读取 C0-C2 data blocks。C6A v4 只能使用
  C5W 已验证先例降低解释门槛，不能编造具体项目/URL 或把 Concept 改得更抽象。
...
- C3/C6A/C6B v4 plain-language marker、正例禁复制、C5W 先例边界；两个
